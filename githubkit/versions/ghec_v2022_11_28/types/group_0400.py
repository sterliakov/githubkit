...
class RepositoryAdvisoryUpdateType(TypedDict):
    ...
    cwe_ids: NotRequired[Union[builtins.list[str], None]]
    ...
    collaborating_users: NotRequired[Union[builtins.list[str], None]]
    collaborating_teams: NotRequired[Union[builtins.list[str], None]]
...
class RepositoryAdvisoryUpdatePropVulnerabilitiesItemsType(TypedDict):
    ...
    vulnerable_functions: NotRequired[Union[builtins.list[str], None]]
