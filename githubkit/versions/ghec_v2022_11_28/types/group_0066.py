...
class CopilotDotcomChatType(TypedDict):
    ...
    total_engaged_users: NotRequired[int]
    models: NotRequired[builtins.list[CopilotDotcomChatPropModelsItemsType]]
...
class CopilotIdeChatType(TypedDict):
    ...
    total_engaged_users: NotRequired[int]
    editors: NotRequired[builtins.list[CopilotIdeChatPropEditorsItemsType]]
...
class CopilotIdeChatPropEditorsItemsType(TypedDict):
    ...
    total_engaged_users: NotRequired[int]
    models: NotRequired[
        builtins.list[CopilotIdeChatPropEditorsItemsPropModelsItemsType]
    ]
...
class CopilotDotcomPullRequestsType(TypedDict):
    ...
    repositories: NotRequired[
        builtins.list[CopilotDotcomPullRequestsPropRepositoriesItemsType]
    ]
...
class CopilotDotcomPullRequestsPropRepositoriesItemsType(TypedDict):
    ...
    total_engaged_users: NotRequired[int]
    models: NotRequired[
        builtins.list[CopilotDotcomPullRequestsPropRepositoriesItemsPropModelsItemsType]
    ]
...
class CopilotIdeCodeCompletionsType(TypedDict):
    ...
    languages: NotRequired[
        builtins.list[CopilotIdeCodeCompletionsPropLanguagesItemsType]
    ]
    editors: NotRequired[builtins.list[CopilotIdeCodeCompletionsPropEditorsItemsType]]
...
class CopilotIdeCodeCompletionsPropEditorsItemsType(TypedDict):
    ...
    total_engaged_users: NotRequired[int]
    models: NotRequired[
        builtins.list[CopilotIdeCodeCompletionsPropEditorsItemsPropModelsItemsType]
    ]
