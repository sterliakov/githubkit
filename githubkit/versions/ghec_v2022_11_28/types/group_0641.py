...
class WebhookIssuesOpenedPropIssueType(TypedDict):
    ...
    assignees: builtins.list[
        Union[WebhookIssuesOpenedPropIssuePropAssigneesItemsType, None]
    ]
    ...
    html_url: str
    id: int
    labels: NotRequired[builtins.list[WebhookIssuesOpenedPropIssuePropLabelsItemsType]]
    labels_url: str
...
class WebhookIssuesOpenedPropChangesPropOldIssueType(TypedDict):
    ...
    id: int
    labels: NotRequired[
        builtins.list[WebhookIssuesOpenedPropChangesPropOldIssuePropLabelsItemsType]
    ]
    labels_url: str
    locked: NotRequired[bool]
