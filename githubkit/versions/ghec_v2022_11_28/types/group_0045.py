...
class AuditLogEventType(TypedDict):
    ...
    config: NotRequired[builtins.list[AuditLogEventPropConfigItemsType]]
    config_was: NotRequired[builtins.list[AuditLogEventPropConfigWasItemsType]]
    ...
    events: NotRequired[builtins.list[AuditLogEventPropEventsItemsType]]
    events_were: NotRequired[builtins.list[AuditLogEventPropEventsWereItemsType]]
