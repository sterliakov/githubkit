...
from .group_0202 import RepositoryAdvisoryCreditType
...
class RepositoryAdvisoryType(TypedDict):
    ...
    author: None
    publisher: None
    identifiers: builtins.list[RepositoryAdvisoryPropIdentifiersItemsType]
    ...
    vulnerabilities: Union[builtins.list[RepositoryAdvisoryVulnerabilityType], None]
    cvss: Union[RepositoryAdvisoryPropCvssType, None]
    cvss_severities: NotRequired[Union[CvssSeveritiesType, None]]
    cwes: Union[builtins.list[RepositoryAdvisoryPropCwesItemsType], None]
    cwe_ids: Union[builtins.list[str], None]
    credits_: Union[builtins.list[RepositoryAdvisoryPropCreditsItemsType], None]
    credits_detailed: Union[builtins.list[RepositoryAdvisoryCreditType], None]
    collaborating_users: Union[builtins.list[SimpleUserType], None]
    collaborating_teams: Union[builtins.list[TeamType], None]
    private_fork: None
