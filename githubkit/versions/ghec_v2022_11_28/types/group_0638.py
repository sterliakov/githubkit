...
from .group_0467 import WebhooksLabelType
...
class WebhookIssuesLabeledPropIssueType(TypedDict):
    ...
    assignees: builtins.list[
        Union[WebhookIssuesLabeledPropIssuePropAssigneesItemsType, None]
    ]
    ...
    html_url: str
    id: int
    labels: NotRequired[builtins.list[WebhookIssuesLabeledPropIssuePropLabelsItemsType]]
    labels_url: str
...
class WebhookIssuesLabeledPropIssuePropSubIssuesSummaryType(TypedDict):
    """Sub-issues Summary"""
