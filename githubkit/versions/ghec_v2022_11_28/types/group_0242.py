...
from .group_0239 import ProtectedBranchPullRequestReviewType
from .group_0241 import BranchRestrictionPolicyType
...
class ProtectedBranchRequiredStatusCheckType(TypedDict):
    ...
    checks: builtins.list[ProtectedBranchRequiredStatusCheckPropChecksItemsType]
