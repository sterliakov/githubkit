...
class GetConsumedLicensesType(TypedDict):
    ...
    users: NotRequired[builtins.list[GetConsumedLicensesPropUsersItemsType]]
...
class GetConsumedLicensesPropUsersItemsType(TypedDict):
    ...
    enterprise_server_user_ids: NotRequired[builtins.list[str]]
    ...
    github_com_member_roles: NotRequired[builtins.list[str]]
    github_com_enterprise_roles: NotRequired[builtins.list[str]]
    github_com_verified_domain_emails: NotRequired[builtins.list[str]]
    github_com_saml_name_id: NotRequired[Union[str, None]]
    github_com_orgs_with_pending_invites: NotRequired[builtins.list[str]]
    github_com_two_factor_auth: NotRequired[Union[bool, None]]
    enterprise_server_emails: NotRequired[builtins.list[str]]
