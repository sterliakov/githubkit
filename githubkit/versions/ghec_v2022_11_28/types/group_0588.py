...
from .group_0597 import WebhookIssueCommentCreatedPropIssueMergedMilestoneType
...
class WebhookIssueCommentCreatedPropIssueType(TypedDict):
    ...
    assignees: builtins.list[WebhookIssueCommentCreatedPropIssueMergedAssigneesType]
    ...
    html_url: str
    id: int
    labels: builtins.list[WebhookIssueCommentCreatedPropIssueAllof0PropLabelsItemsType]
    labels_url: str
    locked: bool
