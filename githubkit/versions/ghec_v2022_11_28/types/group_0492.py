...
class WebhooksPullRequest5Type(TypedDict):
    ...
    assignees: builtins.list[Union[WebhooksPullRequest5PropAssigneesItemsType, None]]
    ...
    id: int
    issue_url: str
    labels: builtins.list[WebhooksPullRequest5PropLabelsItemsType]
    locked: bool
    ...
    requested_teams: builtins.list[WebhooksPullRequest5PropRequestedTeamsItemsType]
