...
from .group_0619 import WebhookIssueCommentEditedPropIssueAllof0PropSubIssuesSummaryType
from .group_0621 import WebhookIssueCommentEditedPropIssueMergedMilestoneType
...
class WebhookIssueCommentEditedPropIssueType(TypedDict):
    ...
    assignees: builtins.list[WebhookIssueCommentEditedPropIssueMergedAssigneesType]
    ...
    html_url: str
    id: int
    labels: builtins.list[WebhookIssueCommentEditedPropIssueAllof0PropLabelsItemsType]
    labels_url: str
    locked: bool
