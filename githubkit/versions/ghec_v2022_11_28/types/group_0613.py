...
from .group_0616 import WebhookIssueCommentEditedPropIssueAllof0PropMilestoneType
...
class WebhookIssueCommentEditedPropIssueAllof0Type(TypedDict):
    ...
    id: int
    labels: NotRequired[
        builtins.list[WebhookIssueCommentEditedPropIssueAllof0PropLabelsItemsType]
    ]
    labels_url: str
