...
class WebhooksSecurityAdvisoryType(TypedDict):
    ...
    cwes: builtins.list[WebhooksSecurityAdvisoryPropCwesItemsType]
    description: str
    ghsa_id: str
    identifiers: builtins.list[WebhooksSecurityAdvisoryPropIdentifiersItemsType]
    published_at: str
    references: builtins.list[WebhooksSecurityAdvisoryPropReferencesItemsType]
    severity: str
    summary: str
    updated_at: str
    vulnerabilities: builtins.list[WebhooksSecurityAdvisoryPropVulnerabilitiesItemsType]
