...
class BranchRestrictionPolicyType(TypedDict):
    ...
    teams_url: str
    apps_url: str
    users: builtins.list[BranchRestrictionPolicyPropUsersItemsType]
    teams: builtins.list[BranchRestrictionPolicyPropTeamsItemsType]
    apps: builtins.list[BranchRestrictionPolicyPropAppsItemsType]
