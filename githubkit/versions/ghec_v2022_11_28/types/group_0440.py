...
from .group_0162 import CodespaceMachineType
from .group_0199 import FullRepositoryType
...
class CodespaceWithFullRepositoryType(TypedDict):
    ...
    recent_folders: builtins.list[str]
...
class CodespaceWithFullRepositoryPropRuntimeConstraintsType(TypedDict):
    ...
    allowed_port_privacy_settings: NotRequired[Union[builtins.list[str], None]]
