...
from .group_0055 import SimpleRepositoryType
from .group_0269 import CodeScanningVariantAnalysisPropScannedRepositoriesItemsType
from .group_0270 import CodeScanningVariantAnalysisPropSkippedRepositoriesType
...
class CodeScanningVariantAnalysisType(TypedDict):
    ...
    scanned_repositories: NotRequired[
        builtins.list[CodeScanningVariantAnalysisPropScannedRepositoriesItemsType]
    ]
