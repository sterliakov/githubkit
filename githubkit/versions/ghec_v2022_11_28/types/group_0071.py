...
from .group_0069 import DependabotAlertSecurityVulnerabilityType
from .group_0070 import DependabotAlertSecurityAdvisoryType
from .group_0072 import DependabotAlertWithRepositoryPropDependencyType
