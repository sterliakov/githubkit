...
class GpgKeyType(TypedDict):
    ...
    key_id: str
    public_key: str
    emails: builtins.list[GpgKeyPropEmailsItemsType]
    subkeys: builtins.list[GpgKeyPropSubkeysItemsType]
    can_sign: bool
...
class GpgKeyPropSubkeysItemsType(TypedDict):
    ...
    emails: NotRequired[builtins.list[GpgKeyPropSubkeysItemsPropEmailsItemsType]]
    subkeys: NotRequired[builtins.list[Any]]
