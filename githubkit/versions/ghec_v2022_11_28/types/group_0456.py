...
from .group_0455 import ExemptionResponseType
...
class ExemptionRequestType(TypedDict):
    ...
    responses: NotRequired[Union[builtins.list[ExemptionResponseType], None]]
...
class ExemptionRequestPushRulesetBypassType(TypedDict):
    ...
    data: NotRequired[builtins.list[ExemptionRequestPushRulesetBypassPropDataItemsType]]
...
class ExemptionRequestSecretScanningType(TypedDict):
    ...
    data: NotRequired[builtins.list[ExemptionRequestSecretScanningPropDataItemsType]]
...
class ExemptionRequestSecretScanningPropDataItemsType(TypedDict):
    ...
    locations: NotRequired[
        builtins.list[ExemptionRequestSecretScanningPropDataItemsPropLocationsItemsType]
    ]
