...
from .group_0473 import WebhooksMilestoneType
...
class WebhookIssuesMilestonedPropIssueType(TypedDict):
    ...
    assignees: builtins.list[
        Union[WebhookIssuesMilestonedPropIssuePropAssigneesItemsType, None]
    ]
    ...
    id: int
    labels: NotRequired[
        builtins.list[Union[WebhookIssuesMilestonedPropIssuePropLabelsItemsType, None]]
    ]
    labels_url: str
...
class WebhookIssuesMilestonedPropIssuePropSubIssuesSummaryType(TypedDict):
    """Sub-issues Summary"""
