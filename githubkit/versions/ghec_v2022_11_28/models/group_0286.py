...
from .group_0287 import PullRequestSimplePropBase, PullRequestSimplePropHead
from .group_0288 import PullRequestSimplePropLinks
...
class PullRequestSimple(GitHubModel):
    ...
    labels: builtins.list[PullRequestSimplePropLabelsItems] = Field()
    ...
    requested_teams: Missing[Union[builtins.list[Team], None]] = Field(default=UNSET)
