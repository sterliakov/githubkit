...
from .group_0196 import CustomPropertyValue
...
class WebhookCustomPropertyValuesUpdated(GitHubModel):
    ...
    new_property_values: builtins.list[CustomPropertyValue] = Field(
        description="The new custom property values for the repository."
    )
    old_property_values: builtins.list[CustomPropertyValue] = Field(
