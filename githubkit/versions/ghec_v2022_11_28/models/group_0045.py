...
class AuditLogEvent(GitHubModel):
    ...
    config: Missing[builtins.list[AuditLogEventPropConfigItems]] = Field(default=UNSET)
    config_was: Missing[builtins.list[AuditLogEventPropConfigWasItems]] = Field(
        default=UNSET
    )
    ...
    events: Missing[builtins.list[AuditLogEventPropEventsItems]] = Field(default=UNSET)
    events_were: Missing[builtins.list[AuditLogEventPropEventsWereItems]] = Field(
        default=UNSET
    )
