...
from .group_0063 import TeamSimple
from .group_0135 import Milestone
from .group_0285 import AutoMerge
from .group_0365 import PullRequestPropLabelsItems
from .group_0366 import PullRequestPropBase, PullRequestPropHead
from .group_0367 import PullRequestPropLinks
...
class PullRequest(GitHubModel):
    ...
    labels: builtins.list[PullRequestPropLabelsItems] = Field()
    ...
    requested_reviewers: Missing[Union[builtins.list[SimpleUser], None]] = Field(
        default=UNSET
    )
    requested_teams: Missing[Union[builtins.list[TeamSimple], None]] = Field(
        default=UNSET
    )
