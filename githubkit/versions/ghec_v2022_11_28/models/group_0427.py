...
class ScimUserList(GitHubModel):
    ...
    schemas: builtins.list[str] = Field(
    ...
    resources: builtins.list[ScimUser] = Field(alias="Resources")
...
class ScimUser(GitHubModel):
    ...
    emails: builtins.list[ScimUserPropEmailsItems] = Field(description="user emails")
    ...
    operations: Missing[builtins.list[ScimUserPropOperationsItems]] = Field(
        min_length=1 if PYDANTIC_V2 else None,
        default=UNSET,
        description="Set of operations to be performed",
    )
    groups: Missing[builtins.list[ScimUserPropGroupsItems]] = Field(
        default=UNSET, description="associated groups"
    )
    roles: Missing[builtins.list[ScimUserPropRolesItems]] = Field(default=UNSET)
...
class ScimUserPropOperationsItems(GitHubModel):
    ...
    value: Missing[
        Union[str, ScimUserPropOperationsItemsPropValueOneof1, builtins.list[Any]]
    ] = Field(default=UNSET)
