...
class WebhooksIssue2(GitHubModel):
    ...
    assignees: builtins.list[Union[WebhooksIssue2PropAssigneesItems, None]] = Field()
    ...
    html_url: str = Field()
    id: int = Field()
    labels: Missing[builtins.list[WebhooksIssue2PropLabelsItems]] = Field(default=UNSET)
    ...
    sub_issues_summary: Missing[WebhooksIssue2PropSubIssuesSummary] = Field(
...
class WebhooksIssue2PropSubIssuesSummary(GitHubModel):
    """Sub-issues Summary"""
...
model_rebuild(WebhooksIssue2PropSubIssuesSummary)
