...
class SecretScanningScanHistory(GitHubModel):
    ...
    incremental_scans: Missing[builtins.list[SecretScanningScan]] = Field(default=UNSET)
    pattern_update_scans: Missing[builtins.list[SecretScanningScan]] = Field(
        default=UNSET
    )
    backfill_scans: Missing[builtins.list[SecretScanningScan]] = Field(default=UNSET)
    custom_pattern_backfill_scans: Missing[
        builtins.list[SecretScanningScanHistoryPropCustomPatternBackfillScansItems]
    ] = Field(default=UNSET)
