...
from .group_0055 import SimpleRepository
from .group_0269 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0270 import CodeScanningVariantAnalysisPropSkippedRepositories
...
class CodeScanningVariantAnalysis(GitHubModel):
    ...
    scanned_repositories: Missing[
        builtins.list[CodeScanningVariantAnalysisPropScannedRepositoriesItems]
    ] = Field(default=UNSET)
