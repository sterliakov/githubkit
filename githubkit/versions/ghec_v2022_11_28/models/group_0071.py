...
from .group_0069 import DependabotAlertSecurityVulnerability
from .group_0070 import DependabotAlertSecurityAdvisory
from .group_0072 import DependabotAlertWithRepositoryPropDependency
