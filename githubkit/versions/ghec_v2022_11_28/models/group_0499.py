...
class WebhooksSecurityAdvisory(GitHubModel):
    ...
    cwes: builtins.list[WebhooksSecurityAdvisoryPropCwesItems] = Field()
    description: str = Field()
    ghsa_id: str = Field()
    identifiers: builtins.list[WebhooksSecurityAdvisoryPropIdentifiersItems] = Field()
    published_at: str = Field()
    references: builtins.list[WebhooksSecurityAdvisoryPropReferencesItems] = Field()
    severity: str = Field()
    summary: str = Field()
    updated_at: str = Field()
    vulnerabilities: builtins.list[WebhooksSecurityAdvisoryPropVulnerabilitiesItems] = (
        Field()
    )
