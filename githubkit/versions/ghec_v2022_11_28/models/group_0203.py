...
from .group_0202 import RepositoryAdvisoryCredit
...
class RepositoryAdvisory(GitHubModel):
    ...
    identifiers: builtins.list[RepositoryAdvisoryPropIdentifiersItems] = Field()
    ...
    vulnerabilities: Union[builtins.list[RepositoryAdvisoryVulnerability], None] = (
        Field()
    )
    cvss: Union[RepositoryAdvisoryPropCvss, None] = Field()
    cvss_severities: Missing[Union[CvssSeverities, None]] = Field(default=UNSET)
    cwes: Union[builtins.list[RepositoryAdvisoryPropCwesItems], None] = Field()
    cwe_ids: Union[builtins.list[str], None] = Field(
        description="A list of only the CWE IDs."
    )
    credits_: Union[builtins.list[RepositoryAdvisoryPropCreditsItems], None] = Field(
        alias="credits"
    )
    credits_detailed: Union[builtins.list[RepositoryAdvisoryCredit], None] = Field()
    collaborating_users: Union[builtins.list[SimpleUser], None] = Field(
        description="A list of users that collaborate on the advisory."
    )
    collaborating_teams: Union[builtins.list[Team], None] = Field(
