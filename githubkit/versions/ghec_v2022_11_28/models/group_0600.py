...
from .group_0607 import WebhookIssueCommentDeletedPropIssueAllof0PropSubIssuesSummary
from .group_0609 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0610 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
...
class WebhookIssueCommentDeletedPropIssue(GitHubModel):
    ...
    assignees: builtins.list[WebhookIssueCommentDeletedPropIssueMergedAssignees] = (
        Field()
    )
    ...
    html_url: str = Field()
    id: int = Field()
    labels: builtins.list[WebhookIssueCommentDeletedPropIssueAllof0PropLabelsItems] = (
        Field()
    )
