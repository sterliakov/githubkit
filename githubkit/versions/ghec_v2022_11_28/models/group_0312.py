...
from .group_0313 import EnvironmentPropProtectionRulesItemsAnyof1PropReviewersItems
...
class EnvironmentPropProtectionRulesItemsAnyof1(GitHubModel):
    ...
    type: str = Field()
    reviewers: Missing[
        builtins.list[EnvironmentPropProtectionRulesItemsAnyof1PropReviewersItems]
    ] = Field(
        default=UNSET,
