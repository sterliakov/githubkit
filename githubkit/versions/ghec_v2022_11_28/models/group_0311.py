...
from .group_0310 import DeploymentBranchPolicySettings
from .group_0312 import EnvironmentPropProtectionRulesItemsAnyof1
...
class ReposOwnerRepoEnvironmentsGetResponse200(GitHubModel):
    ...
    environments: Missing[builtins.list[Environment]] = Field(default=UNSET)
