...
class WebhookIssuesClosedPropIssueAllof1(GitHubModel):
    ...
    assignees: Missing[
        builtins.list[Union[WebhookIssuesClosedPropIssueAllof1PropAssigneesItems, None]]
    ] = Field(default=UNSET)
    ...
    labels: Missing[
        builtins.list[Union[WebhookIssuesClosedPropIssueAllof1PropLabelsItems, None]]
    ] = Field(default=UNSET)
