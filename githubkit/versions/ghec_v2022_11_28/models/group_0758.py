...
from .group_0677 import WebhookRubygemsMetadata
...
class WebhookRegistryPackagePublishedPropRegistryPackagePropPackageVersion(GitHubModel):
    ...
    rubygems_metadata: Missing[builtins.list[WebhookRubygemsMetadata]] = Field(
        default=UNSET
    )
    summary: str = Field()
...
class WebhookRegistryPackagePublishedPropRegistryPackagePropPackageVersionPropDockerMetadataItems(
    ...
    tags: Missing[builtins.list[str]] = Field(default=UNSET)
...
class WebhookRegistryPackagePublishedPropRegistryPackagePropPackageVersionPropNpmMetadata(
    ...
    maintainers: Missing[builtins.list[str]] = Field(default=UNSET)
    contributors: Missing[builtins.list[str]] = Field(default=UNSET)
    engines: Missing[
        WebhookRegistryPackagePublishedPropRegistryPackagePropPackageVersionPropNpmMetadataPropEngines
    ] = Field(default=UNSET)
    keywords: Missing[builtins.list[str]] = Field(default=UNSET)
    files: Missing[builtins.list[str]] = Field(default=UNSET)
    bin_: Missing[
    ...
    os: Missing[builtins.list[str]] = Field(default=UNSET)
    cpu: Missing[builtins.list[str]] = Field(default=UNSET)
