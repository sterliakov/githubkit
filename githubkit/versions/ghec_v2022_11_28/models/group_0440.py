...
from .group_0162 import CodespaceMachine
from .group_0199 import FullRepository
...
class CodespaceWithFullRepository(GitHubModel):
    ...
    recent_folders: builtins.list[str] = Field()
...
class CodespaceWithFullRepositoryPropRuntimeConstraints(GitHubModel):
    ...
    allowed_port_privacy_settings: Missing[Union[builtins.list[str], None]] = Field(
        default=UNSET,
