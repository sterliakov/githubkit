...
from .group_0633 import WebhookIssuesClosedPropIssueMergedMilestone
from .group_0634 import WebhookIssuesClosedPropIssueMergedPerformedViaGithubApp
...
class WebhookIssuesClosedPropIssue(GitHubModel):
    ...
    assignees: builtins.list[WebhookIssuesClosedPropIssueMergedAssignees] = Field()
    ...
    html_url: str = Field()
    id: int = Field()
    labels: Missing[builtins.list[WebhookIssuesClosedPropIssueMergedLabels]] = Field(
        default=UNSET
    )
