...
from .group_0455 import ExemptionResponse
...
class ExemptionRequest(GitHubModel):
    ...
    responses: Missing[Union[builtins.list[ExemptionResponse], None]] = Field(
...
class ExemptionRequestPushRulesetBypass(GitHubModel):
    ...
    data: Missing[builtins.list[ExemptionRequestPushRulesetBypassPropDataItems]] = (
        Field(
            default=UNSET,
...
class ExemptionRequestSecretScanning(GitHubModel):
    ...
    data: Missing[builtins.list[ExemptionRequestSecretScanningPropDataItems]] = Field(
        default=UNSET,
...
class ExemptionRequestSecretScanningPropDataItems(GitHubModel):
    ...
    locations: Missing[
        builtins.list[ExemptionRequestSecretScanningPropDataItemsPropLocationsItems]
    ] = Field(
