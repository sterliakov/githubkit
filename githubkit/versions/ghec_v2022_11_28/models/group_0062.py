...
class GetConsumedLicenses(GitHubModel):
    ...
    users: Missing[builtins.list[GetConsumedLicensesPropUsersItems]] = Field(
        default=UNSET
    )
...
class GetConsumedLicensesPropUsersItems(GitHubModel):
    ...
    enterprise_server_user_ids: Missing[builtins.list[str]] = Field(default=UNSET)
    ...
    github_com_member_roles: Missing[builtins.list[str]] = Field(default=UNSET)
    github_com_enterprise_roles: Missing[builtins.list[str]] = Field(
        default=UNSET, description="All enterprise roles for a user."
    )
    github_com_verified_domain_emails: Missing[builtins.list[str]] = Field(
        default=UNSET
    )
    github_com_saml_name_id: Missing[Union[str, None]] = Field(default=UNSET)
    github_com_orgs_with_pending_invites: Missing[builtins.list[str]] = Field(
        default=UNSET
    )
    github_com_two_factor_auth: Missing[Union[bool, None]] = Field(default=UNSET)
    enterprise_server_emails: Missing[builtins.list[str]] = Field(default=UNSET)
