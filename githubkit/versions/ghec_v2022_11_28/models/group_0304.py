...
class DependencyGraphSpdxSbomPropSbom(GitHubModel):
    ...
    packages: builtins.list[DependencyGraphSpdxSbomPropSbomPropPackagesItems] = Field()
    relationships: Missing[
        builtins.list[DependencyGraphSpdxSbomPropSbomPropRelationshipsItems]
    ] = Field(default=UNSET)
...
class DependencyGraphSpdxSbomPropSbomPropCreationInfo(GitHubModel):
    ...
    creators: builtins.list[str] = Field(
