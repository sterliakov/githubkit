...
from .group_0231 import CodeScanningVariantAnalysisPropScannedRepositoriesItemsType
from .group_0232 import CodeScanningVariantAnalysisPropSkippedRepositoriesType
