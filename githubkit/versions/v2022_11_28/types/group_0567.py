...
from .group_0569 import WebhookIssuesClosedPropIssueAllof0PropMilestoneType
from .group_0571 import WebhookIssuesClosedPropIssueAllof0PropPerformedViaGithubAppType
...
class WebhookIssuesClosedPropIssueAllof0Type(TypedDict):
    ...
    id: int
    labels: NotRequired[
        builtins.list[WebhookIssuesClosedPropIssueAllof0PropLabelsItemsType]
    ]
    labels_url: str
