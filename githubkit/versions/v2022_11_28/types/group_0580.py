...
class WebhookIssuesLockedPropIssueType(TypedDict):
    ...
    assignees: builtins.list[
        Union[WebhookIssuesLockedPropIssuePropAssigneesItemsType, None]
    ]
    ...
    id: int
    labels: NotRequired[
        builtins.list[Union[WebhookIssuesLockedPropIssuePropLabelsItemsType, None]]
    ]
    labels_url: str
    locked: Literal[True]
...
class WebhookIssuesLockedPropIssuePropSubIssuesSummaryType(TypedDict):
    """Sub-issues Summary"""
