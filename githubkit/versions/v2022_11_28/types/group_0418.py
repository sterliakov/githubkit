...
class WebhooksIssueType(TypedDict):
    ...
    assignees: builtins.list[Union[WebhooksIssuePropAssigneesItemsType, None]]
    ...
    html_url: str
    id: int
    labels: NotRequired[builtins.list[WebhooksIssuePropLabelsItemsType]]
    labels_url: str
    ...
    repository_url: str
    sub_issues_summary: NotRequired[WebhooksIssuePropSubIssuesSummaryType]
...
class WebhooksIssuePropSubIssuesSummaryType(TypedDict):
    """Sub-issues Summary"""
