...
from .group_0188 import PullRequestMinimalType
from .group_0189 import SimpleCommitType
...
class WorkflowRunType(TypedDict):
    ...
    referenced_workflows: NotRequired[
        Union[builtins.list[ReferencedWorkflowType], None]
    ]
    event: str
    ...
    url: str
    html_url: str
    pull_requests: Union[builtins.list[PullRequestMinimalType], None]
    created_at: datetime
    updated_at: datetime
