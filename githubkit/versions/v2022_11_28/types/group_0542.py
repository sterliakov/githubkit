...
from .group_0545 import WebhookIssueCommentDeletedPropIssueAllof0PropMilestoneType
...
class WebhookIssueCommentDeletedPropIssueAllof0Type(TypedDict):
    ...
    id: int
    labels: NotRequired[
        builtins.list[WebhookIssueCommentDeletedPropIssueAllof0PropLabelsItemsType]
    ]
    labels_url: str
