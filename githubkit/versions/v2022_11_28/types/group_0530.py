...
from .group_0533 import WebhookIssueCommentCreatedPropIssueAllof0PropMilestoneType
...
class WebhookIssueCommentCreatedPropIssueAllof0Type(TypedDict):
    ...
    id: int
    labels: NotRequired[
        builtins.list[WebhookIssueCommentCreatedPropIssueAllof0PropLabelsItemsType]
    ]
    labels_url: str
