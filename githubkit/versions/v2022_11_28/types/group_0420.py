...
class WebhooksIssue2Type(TypedDict):
    ...
    assignees: builtins.list[Union[WebhooksIssue2PropAssigneesItemsType, None]]
    ...
    html_url: str
    id: int
    labels: NotRequired[builtins.list[WebhooksIssue2PropLabelsItemsType]]
    labels_url: str
    ...
    repository_url: str
    sub_issues_summary: NotRequired[WebhooksIssue2PropSubIssuesSummaryType]
...
class WebhooksIssue2PropSubIssuesSummaryType(TypedDict):
    """Sub-issues Summary"""
