...
from .group_0272 import DeploymentBranchPolicySettingsType
from .group_0274 import EnvironmentPropProtectionRulesItemsAnyof1Type
...
class ReposOwnerRepoEnvironmentsGetResponse200Type(TypedDict):
    ...
    environments: NotRequired[builtins.list[EnvironmentType]]
