...
class WebhookPushType(TypedDict):
    ...
    before: str
    commits: builtins.list[WebhookPushPropCommitsItemsType]
    compare: str
    created: bool
    deleted: bool
...
class WebhookPushPropHeadCommitType(TypedDict):
    ...
    added: NotRequired[builtins.list[str]]
    author: WebhookPushPropHeadCommitPropAuthorType
    committer: WebhookPushPropHeadCommitPropCommitterType
    distinct: bool
    id: str
    message: str
    modified: NotRequired[builtins.list[str]]
    removed: NotRequired[builtins.list[str]]
    timestamp: datetime
    tree_id: str
    url: str
