...
from .group_0249 import PullRequestSimplePropBaseType, PullRequestSimplePropHeadType
from .group_0250 import PullRequestSimplePropLinksType
...
class PullRequestSimpleType(TypedDict):
    ...
    body: Union[str, None]
    labels: builtins.list[PullRequestSimplePropLabelsItemsType]
    ...
    requested_teams: NotRequired[Union[builtins.list[TeamType], None]]
