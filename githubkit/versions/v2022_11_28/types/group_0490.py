...
from .group_0407 import WebhooksApproverType, WebhooksReviewersItemsType
from .group_0408 import WebhooksWorkflowJobRunType
...
class WebhookDeploymentReviewRejectedType(TypedDict):
    ...
    reviewers: NotRequired[builtins.list[WebhooksReviewersItemsType]]
    sender: SimpleUserType
    since: str
    workflow_job_run: NotRequired[WebhooksWorkflowJobRunType]
    workflow_job_runs: NotRequired[
        builtins.list[WebhookDeploymentReviewRejectedPropWorkflowJobRunsItemsType]
    ]
