...
from .group_0550 import WebhookIssueCommentDeletedPropIssueMergedMilestoneType
...
class WebhookIssueCommentDeletedPropIssueType(TypedDict):
    ...
    assignees: builtins.list[WebhookIssueCommentDeletedPropIssueMergedAssigneesType]
    ...
    html_url: str
    id: int
    labels: builtins.list[WebhookIssueCommentDeletedPropIssueAllof0PropLabelsItemsType]
    labels_url: str
    locked: bool
