...
from .group_0574 import WebhookIssuesClosedPropIssueMergedMilestoneType
from .group_0575 import WebhookIssuesClosedPropIssueMergedPerformedViaGithubAppType
...
class WebhookIssuesClosedPropIssueType(TypedDict):
    ...
    assignees: builtins.list[WebhookIssuesClosedPropIssueMergedAssigneesType]
    ...
    html_url: str
    id: int
    labels: NotRequired[builtins.list[WebhookIssuesClosedPropIssueMergedLabelsType]]
    labels_url: str
