...
class WebhookIssuesOpenedPropIssue(GitHubModel):
    ...
    html_url: str = Field()
    id: int = Field()
    labels: Missing[builtins.list[WebhookIssuesOpenedPropIssuePropLabelsItems]] = Field(
        default=UNSET
    )
    ...
    sub_issues_summary: Missing[WebhookIssuesOpenedPropIssuePropSubIssuesSummary] = (
...
class WebhookIssuesOpenedPropIssuePropSubIssuesSummary(GitHubModel):
    """Sub-issues Summary"""
...
class WebhookIssuesOpenedPropChangesPropOldIssue(GitHubModel):
    ...
    id: int = Field()
    labels: Missing[
        builtins.list[WebhookIssuesOpenedPropChangesPropOldIssuePropLabelsItems]
    ] = Field(default=UNSET)
    labels_url: str = Field()
    locked: Missing[bool] = Field(default=UNSET)
...
model_rebuild(WebhookIssuesOpenedPropIssuePropSubIssuesSummary)
