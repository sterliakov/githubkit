...
from .group_0201 import ProtectedBranchPullRequestReview
from .group_0203 import BranchRestrictionPolicy
...
class ProtectedBranchRequiredStatusCheck(GitHubModel):
    ...
    contexts: builtins.list[str] = Field()
    checks: builtins.list[ProtectedBranchRequiredStatusCheckPropChecksItems] = Field()
