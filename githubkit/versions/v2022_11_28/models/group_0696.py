...
class WebhookPush(GitHubModel):
    ...
    commits: builtins.list[WebhookPushPropCommitsItems] = Field(
...
class WebhookPushPropHeadCommit(GitHubModel):
    ...
    added: Missing[builtins.list[str]] = Field(
    ...
    modified: Missing[builtins.list[str]] = Field(
        default=UNSET, description="An array of files modified by the commit."
    )
    removed: Missing[builtins.list[str]] = Field(
