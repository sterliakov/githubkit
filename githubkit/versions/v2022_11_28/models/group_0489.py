...
from .group_0407 import WebhooksApprover, WebhooksReviewersItems
from .group_0408 import WebhooksWorkflowJobRun
...
class WebhookDeploymentReviewApproved(GitHubModel):
    ...
    reviewers: Missing[builtins.list[WebhooksReviewersItems]] = Field(default=UNSET)
    sender: SimpleUser = Field(title="Simple User", description="A GitHub user.")
    since: str = Field()
    workflow_job_run: Missing[WebhooksWorkflowJobRun] = Field(default=UNSET)
    workflow_job_runs: Missing[
        builtins.list[WebhookDeploymentReviewApprovedPropWorkflowJobRunsItems]
    ] = Field(default=UNSET)
