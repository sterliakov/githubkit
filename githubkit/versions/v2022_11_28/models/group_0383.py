...
from .group_0376 import SearchResultTextMatchesItems
...
class TopicSearchResultItem(GitHubModel):
    ...
    related: Missing[
        Union[builtins.list[TopicSearchResultItemPropRelatedItems], None]
    ] = Field(default=UNSET)
    aliases: Missing[
        Union[builtins.list[TopicSearchResultItemPropAliasesItems], None]
    ] = Field(default=UNSET)
...
class SearchTopicsGetResponse200(GitHubModel):
    ...
    items: builtins.list[TopicSearchResultItem] = Field()
