...
from .group_0560 import WebhookIssueCommentEditedPropIssueAllof0PropSubIssuesSummary
from .group_0562 import WebhookIssueCommentEditedPropIssueMergedMilestone
from .group_0563 import WebhookIssueCommentEditedPropIssueMergedPerformedViaGithubApp
...
class WebhookIssueCommentEditedPropIssue(GitHubModel):
    ...
    assignees: builtins.list[WebhookIssueCommentEditedPropIssueMergedAssignees] = (
        Field()
    )
    ...
    html_url: str = Field()
    id: int = Field()
    labels: builtins.list[WebhookIssueCommentEditedPropIssueAllof0PropLabelsItems] = (
        Field()
    )
