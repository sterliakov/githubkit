...
class GpgKey(GitHubModel):
    ...
    emails: builtins.list[GpgKeyPropEmailsItems] = Field()
    subkeys: builtins.list[GpgKeyPropSubkeysItems] = Field()
    can_sign: bool = Field()
...
class GpgKeyPropSubkeysItems(GitHubModel):
    ...
    emails: Missing[builtins.list[GpgKeyPropSubkeysItemsPropEmailsItems]] = Field(
        default=UNSET
    )
    subkeys: Missing[builtins.list[Any]] = Field(default=UNSET)
