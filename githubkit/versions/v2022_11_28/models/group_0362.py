...
class RepositoryAdvisoryUpdate(GitHubModel):
    ...
    vulnerabilities: Missing[
        builtins.list[RepositoryAdvisoryUpdatePropVulnerabilitiesItems]
    ] = Field(
        default=UNSET,
        description="A product affected by the vulnerability detailed in a repository security advisory.",
    )
    cwe_ids: Missing[Union[builtins.list[str], None]] = Field(
        default=UNSET, description="A list of Common Weakness Enumeration (CWE) IDs."
    )
    credits_: Missing[
        Union[builtins.list[RepositoryAdvisoryUpdatePropCreditsItems], None]
    ] = Field(
        default=UNSET,
        alias="credits",
    ...
    collaborating_users: Missing[Union[builtins.list[str], None]] = Field(
        default=UNSET,
        description="A list of usernames who have been granted write access to the advisory.",
    )
    collaborating_teams: Missing[Union[builtins.list[str], None]] = Field(
        default=UNSET,
...
class RepositoryAdvisoryUpdatePropVulnerabilitiesItems(GitHubModel):
    ...
    vulnerable_functions: Missing[Union[builtins.list[str], None]] = Field(
