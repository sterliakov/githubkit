...
from .group_0056 import MinimalRepository
from .group_0188 import PullRequestMinimal
from .group_0189 import SimpleCommit
...
class WorkflowRun(GitHubModel):
    ...
    referenced_workflows: Missing[Union[builtins.list[ReferencedWorkflow], None]] = (
        Field(default=UNSET)
    )
    event: str = Field()
    ...
    html_url: str = Field()
    pull_requests: Union[builtins.list[PullRequestMinimal], None] = Field(
