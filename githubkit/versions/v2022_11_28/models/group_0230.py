...
from .group_0231 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0232 import CodeScanningVariantAnalysisPropSkippedRepositories
