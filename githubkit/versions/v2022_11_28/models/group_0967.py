...
class ReposOwnerRepoBranchesBranchProtectionPutBodyPropRestrictions(GitHubModel):
    ...
    users: builtins.list[str] = Field(
        description="The list of user `login`s with push access"
    )
    teams: builtins.list[str] = Field(
