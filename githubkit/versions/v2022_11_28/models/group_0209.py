...
from .group_0208 import DiffEntry
from .group_0210 import CommitPropCommit
...
class Commit(GitHubModel):
    ...
    parents: builtins.list[CommitPropParentsItems] = Field()
    stats: Missing[CommitPropStats] = Field(default=UNSET)
    files: Missing[builtins.list[DiffEntry]] = Field(default=UNSET)
